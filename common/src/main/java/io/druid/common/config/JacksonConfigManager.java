...
public class JacksonConfigManager
{
  ...
  public <T extends AuditableConfig> boolean set(String key, T val)
  {
    ConfigSerde<AuditableConfig> configSerde = create(val.getClass(), null);
