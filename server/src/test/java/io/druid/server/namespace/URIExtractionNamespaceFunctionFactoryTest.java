...
public class URIExtractionNamespaceFunctionFactoryTest
{
    ...
    return ImmutableList.<Object[]>of(
        new Object[]{
            ...
            new Function<File, OutputStream>()
            {
              ...
              @Nullable
              @Override
              public OutputStream apply(File outFile)
              {
                try {
                  final OutputStream fileOut = new FileOutputStream(outFile);
  ...
  public void setUp() throws IOException
  {
    ...
    namespace = new URIExtractionNamespace("ns", tmpFile.toURI(), false);
  }
