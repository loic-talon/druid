...
public class LocalDataSegmentPullerTest
{
  ...
  private OmniSegmentLoader segmentLoader;
  ...
  public void setup()
  {
    ...
    segmentLoader = new OmniSegmentLoader(
        ImmutableMap.<String, DataSegmentPuller>of("file", puller),
        null,
  ...
  public void simpleZipTest() throws IOException, SegmentLoadingException
  {
    ...
    try {
      ...
      segmentLoader.loadURI(ImmutableMap.<String, Object>of("uri", zipFile.toURI()), tmpDir);
  ...
  public void simpleDirectoryTest() throws IOException, SegmentLoadingException
  {
    ...
    try{
      ...
      segmentLoader.loadURI(ImmutableMap.<String, Object>of("uri", srcDir.toURI()), tmpDir);
