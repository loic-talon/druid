...
public class SQLAuditManager implements AuditManager
{
  ...
  public void doAudit(AuditEntry auditEntry, Handle handle) throws IOException
  {
    emitter.emit(
        new ServiceMetricEvent.Builder()
            ...
            .setUser4(auditEntry.getAuditInfo().getEmailId())
    ...
    handle.createStatement(
        String.format(
            "INSERT INTO %s ( audit_key, type, author, email_id, comment, created_date, payload) VALUES (:audit_key, :type, :author, :email_id, :comment, :created_date, :payload)",
            getAuditTable()
        )
    )
          ...
          .bind("email_id", auditEntry.getAuditInfo().getEmailId())
  ...
  @Override
  public List<AuditEntry> fetchAuditHistory(final String key, final String type, final Interval interval)
  {
            ...
            return handle.createQuery(
                String.format(
                    ...
                    getAuditTable()
                         ...
                         .bind("type", type)
                         .bind("start_date", interval.getStart().toString())
                         .bind("end_date", interval.getEnd().toString())
                         .map(
